...
![piece state.drawio](docs/piece%20state.drawio.png)
...
![command pattern uml](docs/command%20pattern%20uml.png)
...
- **Coverage Report:**
![coverage report png](docs/coverage%20report.png)
- **Mutation Testing Report:**
-![mutation report png](docs/mutation%20tests%20report.png)
